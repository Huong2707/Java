...
public class SanPhamController {
    public List<SanPham> getSanPham(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                ob.setHinhAnh(rs.getString("HinhAnh"));
    ...
    public boolean ThemSanPham(SanPham sp){
        ...
        try{
            ...
            prSt.setString(3, sp.getMoTa());
            prSt.setInt(4, sp.getSoLuong());
            prSt.setString(5, sp.getHinhAnh());
            prSt.setFloat(6, sp.getDonGia());
            prSt.setString(7, sp.getMaLoaiSP());
    ...
    public boolean SuaSanPham(SanPham sp){
        String sql = "update SanPham set TenSP = ?, MoTa = ?, SoLuong = ?, HinhAnh = ?, DonGia = ?, MaLoaiSP = ? where MaSP = ? ";
        try{
            Connection db = new Connect().connect(); 
            PreparedStatement prSt = db.prepareStatement(sql);
            prSt.setString(7, sp.getMaSP());
            prSt.setString(1, sp.getTenSP());
            prSt.setString(2, sp.getMoTa());
            prSt.setInt(3, sp.getSoLuong());
            prSt.setString(4, sp.getHinhAnh());
