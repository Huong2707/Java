...
public class NhanVienController {
    public List<NhanVien> getNhanVien(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                ob.setTenTaiKhoan(rs.getString("TenTaiKhoan"));
    ...
    public boolean ThemNhanVien(NhanVien sp){
        ...
        try{
            ...
            prSt.setString(8, sp.getTenTaiKhoan());
    ...
    public boolean SuaNhanVien(NhanVien sp){
        String sql = "update NhanVien set TenNV = ?, NgaySinh = ?, GioiTinh = ?, DiaChi = ?, ChucVu = ?, SĐT= ?, TenTaiKhoan = ? where MaNV = ? ";
        try{
            Connection db = new Connect().connect(); 
            PreparedStatement prSt = db.prepareStatement(sql);
            ...
            prSt.setString(7, sp.getTenTaiKhoan());
